...
<script src="view/assets/plugins/jquery/jquery-1.11.1.min.js"></script>

<script src="view/assets/plugins/bootstrap/js/bootstrap.min.js"></script>

<script src="view/assets/plugins/bootstrap-select/js/bootstrap-select.min.js"></script>

<script src="view/assets/plugins/superfish/js/superfish.min.js"></script>

<script src="view/assets/plugins/prettyphoto/js/jquery.prettyPhoto.js"></script>

<script src="view/assets/plugins/owl-carousel2/owl.carousel.min.js"></script>

<script src="view/assets/plugins/jquery.sticky.min.js"></script>

<script src="view/assets/plugins/jquery.easing.min.js"></script>

<script src="view/assets/plugins/jquery.smoothscroll.min.js"></script>

<!--<script src="assets/plugins/smooth-scrollbar.min.js"></script>-->

<script src="view/assets/plugins/wow/wow.min.js"></script>
...
<script src="view/assets/plugins/swiper/js/swiper.jquery.min.js"></script>

<script src="view/assets/plugins/datetimepicker/js/moment-with-locales.min.js"></script>

<script src="view/assets/plugins/datetimepicker/js/bootstrap-datetimepicker.min.js"></script>



<!-- JS Page Level -->

<script src="view/assets/js/theme-ajax-mail.js"></script>
...
<script src="view/view/assets/plugins/jquery.cookie.js"></script>
...
<!-- Mirrored from jthemes.net/themes/f-html/reEstate/realeastate/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 04 Nov 2022 15:16:30 GMT -->
</html>