 ...
 <head>
     ...
     <!-- App favicon -->
     <link rel="shortcut icon" href="assets/images/hpv">
                                 ...
                                 <div class="col-lg-6">
                                     <div class="p-lg-5 p-4">
                                             ...
                                             <form class="needs-validation"  action="index.php?act=dangky" method="POST">
                                                 ...
                                                 <div class="mb-3">
                                                     ...
                                                     <div class="position-relative auth-pass-inputgroup">
                                                         <input type="password" name="pass" class="form-control pe-5 password-input" onpaste="return false" placeholder="Enter password" id="password-input" aria-describedby="passwordInput" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required>
                                                 ...
                                                 <h6 class="thongbao">
                                                     ...
                                                     <input class="btn btn-success w-100" type="submit" name="dangky" value="Sign Up">
                                                 </div>
                                         ...
                                         <div class="mt-5 text-center">
                                             <p class="mb-0">Already have an account ? <a href="index.php?act=dangnhap" class="fw-semibold text-primary text-decoration-underline"> Signin</a> </p>
                                         </div>
                                     </div>
                                 </div>
                             </div>
